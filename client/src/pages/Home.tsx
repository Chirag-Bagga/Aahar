...
const Home: React.FC = () => {
  return (
    <>
      <div className="grid sm:grid-cols-3 grid-cols-2 m-auto" data-translate="message">
        <div className="col-span-2 m-5" data-translate="message">
          <p className="font-roboto font-semibold text-8xl m-5" data-translate="message">
        ...
        <div data-translate="message">
          <img src={Hero} alt="Hero" className="h-auto w-full" data-translate="message" />
        </div>
      </div>

      <div className="text-center font-roboto font-semibold text-5xl" data-translate="message">
        What We Provide:
      </div>

      <div className="grid sm:grid-cols-2 grid-cols-2" data-translate="message">
        <div
          className="col-span-1 m-5 bg-white rounded-2xl p-4 shadow-2xl transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110"
          data-translate="message"
        >
          <div
          ...
          <p className="font-roboto text-lg m-5" data-translate="message">
